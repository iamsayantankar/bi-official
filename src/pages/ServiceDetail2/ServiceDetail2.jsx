    ...
    <div>
        ...
        <div className="page-header flex-middle page-header-service">
          <div className="container">
            <div className="inner flex-middle">
              <h1 className="page-title">Organizational Audit</h1>
              <ul id="breadcrumbs" className="breadcrumbs none-style">
                <li>
                  <Link to="/">Home</Link>
                </li>
                <li className="active">Organizational Audit</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section>
        <div className="container">
          ...
          <div className="service-top-detail2">
            <div className="row">
              <div className="col-lg-5">
                ...
                <div className="ot-button">
                  <a href="#" className="octf-btn octf-btn-dark">
                    get in touch
                  </a>
                </div>
              </div>
          ...
          <div className="row">
            <div className="col-lg-6 mb-5 mb-lg-0">
              ...
              <div className="ot-accordions pr-xl-5">
      ...
      <section className="service-benefit-detail2">
        <div className="container">
          <div className="space-100"></div>
          <div className="row">
            <div className="col-lg-12 text-center">
              <div className="ot-heading">
                ...
                <h3 className="main-head text-white">Why Clients Choose Us</h3>
              </div>
          ...
          <div className="row">
            <div className="col-xl-3 col-md-6 mb-4 mb-xl-0">
              <div className="hover-dark-yes">
                <div className="icon-box icon-box-1 icon-service-2">
      ...
      <section>
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-6 mb-5 mb-lg-0">
              <div className="ot-heading">
                <span className="is_highlight">reliable &amp; safe</span>
                <h3 className="main-head">Our Strategy Development</h3>
              </div>
              <div className="space-20"></div>
              <div className="ot-tabs pr-xl-5 ">
                <ul className="tabs-heading unstyle">
                  <li
                    className={ `tab-link ${ activeTab === "tab-1841" ? "current" : ""
                      }` }
                  ...
                  <li
                    className={ `tab-link ${ activeTab === "tab-2841" ? "current" : ""
                      }` }
                  ...
                  <li
                    className={ `tab-link ${ activeTab === "tab-3841" ? "current" : ""
                      }` }
                ...
                <div
                  id="tab-1841"
                  className={ `tab-content ${ activeTab === "tab-1841" ? "current" : ""
                    }` }
                >
                  <p>
                ...
                <div
                  id="tab-2841"
                  className={ `tab-content ${ activeTab === "tab-2841" ? "current" : ""
                    }` }
                >
                  <p>
                ...
                <div
                  id="tab-3841"
                  className={ `tab-content ${ activeTab === "tab-3841" ? "current" : ""
                    }` }
                >
                  <p>
            ...
            <div className="col-lg-6 align-self-end">
              <div className="service-tab-img text-center">
