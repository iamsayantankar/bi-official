...
const Home = () =>
{
  return (
    <div>
      ...
      <Helmet>
        <meta charSet="utf-8" />
        <title>Software companies in Kolkata - BetaZen InfoTech</title>
        <link rel="canonical" href="http://betazeninfotech.com/" />

        <meta name="description" content=" Are you searching for a software development company in Kolkata?  Partner with us, one among the reputable software companies in Kolkata, to drive growth. " />

        <meta name="keywords" content=" software companies in Kolkata, software development company in Kolkata" />
      ...
      <section id="about" className="consulting-priorities">
              ...
              <div className="consulting-priorities-desc">
                ...
                <div className="icon-list d-flex">
                  ...
                  <div className="content-box">
                    ...
                    <p>
                      BetaZen InfoTech is a software development company in Kolkata that develops software, with a specialization in app development. Being situated in Kolkata, our software development company benefits from having a strong local presence. This gives us a unique advantage as we possess extensive knowledge and insights into the local market. With this understanding, we are able to customize your app to specifically suit the preferences and requirements of the Kolkata audience. Our close proximity enables efficient and direct communication, personalized attention, and prompt support throughout the development process. As a result, we can deliver well-crafted applications that perfectly align with the needs of our local clients.
                    </p>
                  </div>
                </div>
          ...
          <div className="row align-items-center">
            <div className="col-lg-5 mb-5 mb-lg-0">
              <div className="ot-heading">
                ...
                <h3 className="main-head">
                  Maximize your business with our software development company in Kolkata
                </h3>
              </div>
            </div>
            <div className="col-lg-7">
              <p className="mb-0">
                We serve Kolkata clients at every level of their organization. Our Team delivers finely tuned applications that perfectly meet the needs of our local clients
              </p>
            </div>
          </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="icon-box icon-box-1 consulting-icon-box">
                ...
                <div className="content-box">
                  ...
                  <p>
                    In Kolkata, we provide cost-effective and high-quality website development services, utilizing our knowledge of the local market to create successful designs. Our commitment to client satisfaction is evident through our in-person assistance, on-time project delivery, effective strategies, transparent communication, and customer-centric approach.
                  </p>
                </div>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="icon-box icon-box-1 consulting-icon-box">
                ...
                <div className="content-box">
                  ...
                  <p>
                    We specialize in creating customized Android and iOS mobile applications. With extensive knowledge and experience in Kolkata, we develop personalized apps that cater to the unique needs of our clients.
                  </p>
                </div>
                <div className="link-box">
                  <a href="#" className="link-details">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="icon-box icon-box-1 consulting-icon-box">
                ...
                <div className="content-box">
                  ...
                  <p>
                    As experienced SEO experts based in Kolkata, we utilize our in-depth understanding of the local market to achieve significant global results. Our methodologies are designed to connect with the regional audience while also catering to a wider target demographic, maximizing the effectiveness of our outreach efforts both locally and internationally.
                  </p>
                </div>
                <div className="link-box">
                  <a href="#" className="link-details">
          ...
          <div className="row justify-content-center">
            <div className="col-lg-4 col-md-6 mb-5 mb-lg-0">
              <div className="ot-image-box hover-transfoem-none">
                ...
                <div className="content-box">
                  <h5 className="title-box">
                    <a href="#">Software Planning</a>
                  </h5>
                  <p>
                    Empower your project with precision through our strategic Software Planning. Maximize efficiency, ensure timely execution, and achieve digital success with our tailored planning solutions. Elevate your software strategy today.
                  </p>
                </div>
                <a href="/Software-Development" className="link-box font-second">
            ...
            <div className="col-lg-4 col-md-6 mb-5 mb-lg-0">
              <div className="ot-image-box hover-transfoem-none">
                ...
                <div className="content-box">
                  <h5 className="title-box">
                    <a href="#">SEO, Design & Marketing</a>
                  </h5>
                  <p>
                    Fuel your online success with our dynamic trio: SEO, Design & Marketing. Elevate your brand, captivate audiences, and boost visibility with our integrated solutions. Drive results, dominate digital.
                  </p>
                </div>
                <a href="/SEO" className="link-box font-second">
                  <span>Explore More</span>
                  <i className="ot-flaticon-trajectory"></i>
                </a>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="ot-image-box hover-transfoem-none">
                ...
                <div className="content-box">
                  ...
                  <p>
                    Drive success with meticulous Business Planning. Our strategic approach ensures growth, efficiency, and sustainable results. Elevate your business vision with our tailored planning solutions, designed for lasting prosperity.
                  </p>
                </div>
      ...
      {/* <section>
        <div className="container">
          ...
          <div className="row">
            <div className="col-lg-8 offset-lg-2 text-center">
              <div className="ot-heading">
                <span className="is_highlight">our blog</span>
                <h3 className="main-head">Read Our Latest Insights</h3>
              </div>
              <div className="space-20"></div>
              <p className="px-xl-5">
                We help you see the world differently, discover opportunities
          ...
          <div className="row justify-content-center">
            <div className="col-lg-4 col-md-6">
              <article className="post-box post-box-main">
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="ot-button text-center">
                <Link to="/blog" className="octf-btn octf-btn-main">
                  view all
                </Link>
              </div>
            </div>
