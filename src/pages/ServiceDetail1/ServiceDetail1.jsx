        ...
        <div className="page-header flex-middle page-header-service">
          <div className="container">
            <div className="inner flex-middle">
              <h1 className="page-title">Marketing Research</h1>
              <ul id="breadcrumbs" className="breadcrumbs none-style">
                <li>
                  <Link to="/">Home</Link>
                </li>
                <li className="active">Marketing Research</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-xl-9 col-lg-8 mb-5 mb-lg-0">
              <img src="images/service-box1.jpg" alt className="rounded-img" />
              ...
              <div className="service-quote">
                <div className="service-quote-desc">
                  ...
                  <p>developing financial processes and procedures</p>
                </div>
              </div>
              <div className="space-60"></div>
