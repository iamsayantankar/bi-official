                ...
                <div className="inner-post">
                  ...
                  <div className="entry-summary">
                    <p>
                      <span className="drop-cap">
                        <span className="drop-cap-letter">N</span>
                      </span>
                    ...
                    <p>
                      <span className="text-color-dark font-weight-600">
                  ...
                  <div className="author-bio">
                    ...
                    <div className="author-info">
                      <p className="title text-color-primary font-second">Author</p>
                      <h6>Samanta Fox</h6>
                      <p className="des">
                  ...
                  <div className="post-nav clearfix">
                  ...
                  <div className="related-posts">
                    ...
                    <div className="row">
                      <div className="col-md-6">
                        <div className="post-box post-item relate-box">
                          <div className="post-inner">
                            ...
                            <div className="entry-meta">
                              ...
                              <a className="btn-details" href="post.html">
                                <i className="ot-flaticon-trajectory"></i>
                              </a>
                            </div>
                          </div>
                      ...
                      <div className="col-md-6">
                        <div className="post-box blog-item relate-box">
                          <div className="post-inner">
                            <div className="entry-media post-cat-abs">
                              <a href="post.html">
                ...
                <ul className="recent-news clearfix">
                  <li className="clearfix">
                    ...
                    <div className="entry-header">
                      ...
                      <span className="post-on">
                        <span className="entry-date">SEPTEMBER 4, 2020</span>
                      </span>
                    </div>
                  </li>
                  ...
                  <li className="clearfix">
                    ...
                    <div className="entry-header">
                      ...
                      <span className="post-on">
                        <span className="entry-date">FEBRUARY 24, 2020</span>
                      </span>
                    </div>
                  </li>
