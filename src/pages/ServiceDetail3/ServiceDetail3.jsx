    ...
    <div>
          ...
          <div className="container">
            <div className="inner flex-middle">
              ...
              <ul id="breadcrumbs" className="breadcrumbs none-style">
                ...
                <li className="active">Business Consulting</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <section>
        <div className="container">
          ...
          <div className="row">
            <div className="col-xl-3 col-lg-4 widget-area mb-5 mb-lg-0">
              ...
              <aside className="widget">
                <h6 className="widget-title">Brochures</h6>
                <a href="#">
            ...
            <div className="col-xl-9 col-lg-8">
              ...
              <div className="service-top-detail3">
                <div className="row">
                  <div className="col-xl-5 col-lg-10">
                    ...
                    <div className="ot-button">
                      <a href="#" className="octf-btn octf-btn-light">
                        get in touch
                      </a>
                    </div>
                  </div>
              ...
              <div className="row align-items-center">
                ...
                <div className="col-md-6">
                  ...
                  <div className="space-20"></div>
                  <div className="line-progress" data-percent="70">
